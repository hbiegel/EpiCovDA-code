function plotICCpresentation_v1(state_id,last_day,K_choices,forecast_date,target)
...
%         'LineWidth',1.5,'HandleVisibility','off')
    ...
    plot(all_fitsC',all_fitsG','Color',0*[1,1,1],...
        'DisplayName','EpiCovDA','LineWidth',4)
...
%         'LineWidth',1.5,'HandleVisibility','off')
    ...
    plot(date_array,smTruthG, 'DisplayName','Time Averaged Values',...
        'Color',[3, 127, 252]/255,'LineWidth',3)
    plot(date_array(last_day-S:last_day+tlast),all_fitsG','Color',0*[1,1,1],...
        'DisplayName','EpiCovDA','LineWidth',4)
     legend('Location','northwest')
     title([state_id ' forecast on ' forecast_date])
