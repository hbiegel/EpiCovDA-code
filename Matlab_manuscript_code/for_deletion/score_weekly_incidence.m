function score_weekly_incidence(forecast_date,state_id,data_choice)
...
forecast_file = ['quantile_forecasts/' data_choice '_wk_' state_id '_' ...
                forecast_date '.csv'];
...
truth = cumsum(truth);
truth(8:end) = truth(8:end) - truth(1:end-7); 
truth_0 = 0;
...
ylabel([data_choice ' over 7 days'])
