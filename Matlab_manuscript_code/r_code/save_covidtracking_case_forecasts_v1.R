# save_covidtracking_case_forecasts_v1
...
setwd("/Users/hannah.biegel/Dropbox/UA/Research/HRB_COVID_code_PAPER/r_code")
...
for (forecast_date in all_forecast_dates){
  ...
  filename = sprintf("UA-EpiCovDA-v3-alphaData-tube1-prior-2020-11-16-alignJHU-PAPER/%s-UA-EpiCovDA.csv",as.Date(forecast_date))
